...
import 'package:my_sports_app/Screens/Player/widgets/_addskill.dart';
import 'package:my_sports_app/Utils/them.dart';

import '../../../../Utils/size_utils.dart';


class Player_info extends StatefulWidget {
  const Player_info({super.key});

  @override
  State<Player_info> createState() => _Player_infoState();

  void onAddSkill() {}
}

class _Player_infoState extends State<Player_info> {
