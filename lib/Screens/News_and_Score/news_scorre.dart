    ...
    return
      ...
      Scaffold(
          ...
          appBar: CustomAppBar(
              ...
              centerTitle: true,
              title: AppbarSubtitle(text: enUs["lbl_news_score"]!,
                  margin: getMargin(top: 7, bottom: 3)),
              actions: [
                Padding(
                  padding: const EdgeInsets.only(
                      top: 0.0, right: 15, bottom: 15),
                  child: Image.asset(
          ...
          body: SizedBox(width: mediaQueryData.size.width,
                                ...
                                child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(padding: getPadding(left: 25,
                                        ...
                                        SizedBox(width: getHorizontalSize(127),
                                            child: Text(
                                                enUs[ "msg_lucas_lavallee_extends"]!,
                                                maxLines: 2,
                                                overflow: TextOverflow.ellipsis,
                                                style: CustomTextStyles
                                                    .poppinsBlack90001Medium)),
                                        Container(width: getHorizontalSize(73),
                                            margin: getMargin(left: 52),
                                            child: Text(
                                                enUs[ "msg_pictures_of_tuesday_s"]!,
                                                maxLines: 2,
                                                overflow: TextOverflow.ellipsis,
                                                style: CustomTextStyles
                                                    .poppinsBlack90001Medium))
                                          ...
                                          child: Container(
                                              ...
                                              decoration: BoxDecoration(
                                                  color: theme.colorScheme
                                                      .primary))),
                                      Container(height: getVerticalSize(34),
