                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          items: games
                              .map<DropdownMenuItem<String>>((String game) {
                            ...
                            child: Stack(
                              children: [
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                          height:
                                              8), // Add some spacing between the skill name and level
                                      Text(
                                          "Level: ${skills[i].level ?? 'N/A'}"),
                                      SizedBox(height: 8),
                                      Text(
                                ...
                                Positioned(
                                  ...
                                  child: IconButton(
                                    icon: Icon(Icons
                                        .delete_forever), // Use the close icon or any other delete icon you prefer
                                    onPressed: () {
                                      setState(() {
                                        skills.removeAt(i);
                                      });
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              labelStyle: TextStyle(
                                  color: Colors
                                      .blue), // Change label text color (if any)
                            ...
                            maxLines:
                                null, // Set maxLines to null for unlimited lines or a specific number
