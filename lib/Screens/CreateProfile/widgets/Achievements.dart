        ...
        child: Scaffold(
            ...
            body: Form(
                ...
                child: SingleChildScrollView(
                  ...
                  Padding(
                      padding:
                          getPadding(left: 15, top: 30, right: 18, bottom: 10),
                      child: Column(
...
//category
                            ...
                            Container(
                              decoration: BoxDecoration(
                                color: Colors.grey[
                                    200], // Set the background color to gray
                              ...
                              child: Padding(
                                ...
                                child: DropdownButton<String>(
                                  ...
                                  hint: Text(
                                      "Please select category"), // Set the hint text
                                  items: [
                                    "Position 1",
                                    "Position 2",
                                    "Position 3",
  ...
  void onTapNext() {
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => Sports_Category_info()));
  }
}
        ...
        Expanded(
          ...
          child: Padding(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor:
                    isPreTrainingSelected ? Colors.pink : Colors.white,
              ),
              child:
                  Text("Pre Training", style: TextStyle(color: Colors.black)),
            ),
          ),
        ),
      ],
