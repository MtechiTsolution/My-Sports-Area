...
class CustomTextFormField extends StatelessWidget {
  ...
  Widget get textFormFieldWidget => Container(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.bodyMediumPoppinsLight,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodyMediumPoppinsLight,
        prefixIcon: prefix,
...
extension TextFormFieldStyleHelper on CustomTextFormField {
  ...
  static OutlineInputBorder get fillBlueGrayTL12 => OutlineInputBorder(
  ...
  static OutlineInputBorder get fillBlueGrayTL5 => OutlineInputBorder(
        borderRadius: BorderRadius.circular(getHorizontalSize(5.00)),
        borderSide: BorderSide.none,
      );
